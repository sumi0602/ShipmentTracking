...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Shipments'); ?> — TrackFlow</title>
...
<body>
    ...
    <nav class="nav">
        <div class="nav__inner">
            <a href="<?php echo e(route('shipments.index')); ?>" class="nav__logo">
                <span class="nav__logo-dot"></span>
                TrackFlow
            </a>
            <a href="<?php echo e(route('shipments.index')); ?>" class="nav__link">All Shipments</a>
        </div>
    </nav>
    ...
    <?php if(session('success')): ?>
        <div class="flash">
            <p class="flash__msg"><?php echo e(session('success')); ?></p>
        </div>
    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\shipment-tracker\resources\views/layouts/app.blade.php ENDPATH**/ ?>